/*
  # Fix Column Names in Consolidated Reminders
  
  1. Cambios
    - Corrige created_by a reporter_id
    - Corrige assigned_to a assigned_to_id
*/
...
COMMENT ON FUNCTION generate_consolidated_daily_reminders IS 'Genera y envía recordatorios diarios consolidados a gestores SST a las 8:00 AM';
