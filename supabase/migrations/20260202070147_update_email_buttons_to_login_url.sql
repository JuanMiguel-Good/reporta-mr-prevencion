/*
  # Update Email Buttons to Login URL

  1. Changes
    - Update all email notification functions to use https://reporta.goodsolutions.app/login
    - Applies to: pending assignment reminders, deadline reminders
    
  2. Purpose
    - Ensure all email buttons redirect to the correct login page
*/

-- Update pending assignment reminders function
...
-- Update deadline reminders function
